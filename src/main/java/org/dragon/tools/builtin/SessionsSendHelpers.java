...
/**
 * sessions_send 工具的辅助类 — 公告/回复上下文构建器和
 * ping-pong 轮次配置。
 * 对应 TypeScript sessions-send-helpers.ts。
 */
public class SessionsSendHelpers {
    ...
    public static int resolvePingPongTurns(ConfigProperties cfg) {
        // ConfigProperties doesn't have session config, return default
